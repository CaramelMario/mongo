...
namespace mongo {
    ...
    public:
        RocksCounterManager(rocksdb::DB* db, rocksdb::ColumnFamilyHandle *cfHandle, bool crashSafe)
            : _db(db), _cfHandle(cfHandle), _crashSafe(crashSafe), _syncing(false), _syncCounter(0) {}
