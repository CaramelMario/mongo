...
namespace mongo {
    ...
    public:
        RocksIndexBase(rocksdb::DB* db, rocksdb::ColumnFamilyHandle* cfHandle,
    ...
    public:
        RocksUniqueIndex(rocksdb::DB* db, rocksdb::ColumnFamilyHandle* cfHandle,
                         std::string prefix, std::string ident, Ordering order,
    ...
    public:
        RocksStandardIndex(rocksdb::DB* db, rocksdb::ColumnFamilyHandle* cfHandle,
                           std::string prefix, std::string ident, Ordering order,
                           const BSONObj& config);
